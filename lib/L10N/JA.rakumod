...
#- Generated on 2024-01-27T22:00:58Z by ./update-localization
...
role L10N::JA {
    ...
    method trait-is2ast {
        my %mapping = "隻が建造されました", "built", "部", "copy", "デフォルト", "default", "非推奨", "DEPRECATED", "当量", "equiv", "輸出", "export", "バックトレースからの隠蔽", "hidden-from-backtrace", "USAGEから非表示", "hidden-from-USAGE", "実装の詳細", "implementation-detail", "ゆるい", "looser", "ノード", "nodal", "ピュア", "pure", "生", "raw", "テストアサーション", "test-assertion", "きつめ", "tighter";
        my $ast := self.ast;
        my $name := $ast ?? $ast.simple-identifier !! self.Str;
        if %mapping{$name} -> $original {
            RakuAST::Name.from-identifier($original)
    ...
    method adverb-pc2str (str $key) {
        my %mapping = "削除", "delete", "は存在します", "exists", "キロボルト", "kv";
        %mapping{$key} // $key
    }
    method adverb-q2str (str $key) {
        my %mapping = "配列", "array", "バックスラッシュ", "backslash", "閉店", "closure", "ダブル", "double", "幹部", "exec", "フォーマット", "format", "関数", "function", "時", "h", "ハッシュ", "hash", "ヒアドキュメント", "heredoc", "時", "o", "名言", "quotewords", "秒", "s", "スカラー", "scalar", "シングル", "single", "～", "to", "ヴァル", "val", "単語", "words", "×", "x";
        %mapping{$key} // $key
    }
    method adverb-rx2str (str $key) {
        my %mapping = "続ける", "continue", "元", "ex", "徹底的に", "exhaustive", "グローバル", "global", "私", "i", "無視ケース", "ignorecase", "無視マーク", "ignoremark", "Ⅱ", "ii", "番目", "nd", "n番目", "nth", "オーバーラップ", "overlap", "ポーズ", "pos", "ラチェット", "ratchet", "番目", "rd", "秒", "s", "同じケース", "samecase", "セイムマーク", "samemark", "セイムスペース", "samespace", "シグスペース", "sigspace", "SS", "ss", "番", "st", "～", "to", "×", "x";
        %mapping{$key} // $key
    }
    method named2str (str $key) {
        my %mapping = "絶対", "absolute", "のアクション", "actions", "API", "api", "追加", "append", "引数0", "arg0", "引数", "args", "として", "as", "で", "at", "認証", "auth", "ベース名", "basename", "バッチ", "batch", "ビン", "bin", "ブリード", "bleed", "放送", "broadcast", "キャッチ", "catch", "小切手", "check", "ムシャムシャ", "chomp", "閉じる", "close", "コマンド", "command", "補数", "complement", "完全に", "completely", "続ける", "continue", "コントロール", "control", "カウント", "count", "作成する", "create", "作成のみ", "createonly", "CWD", "cwd", "日付", "date", "日", "day", "度", "degree", "削除", "delete", "姓名", "dirname", "要素", "elems", "発光時間指定", "emit-timed", "エンコーディング", "encoding", "エンド", "end", "エラー", "err", "ごと", "every", "元", "ex", "限定", "exclusive", "網羅的", "exhaustive", "の有効期限が切れます", "expires", "家族", "family", "ファイル名", "filename", "フィルター", "filter", "フォーマッタ", "formatter", "ギッド", "gid", "グローバル", "global", "ホスト", "host", "時間", "hour", "私", "i", "無視されるケース", "ignorecase", "無視マーク", "ignoremark", "Ⅱ", "ii", "インチ", "in", "に", "into", "ジョイナー", "joiner", "キー", "key", "聞いてください", "listen", "ローカルホスト", "localhost", "ローカルポート", "localport", "試合", "match", "マージ", "merge", "分", "minute", "モード", "mode", "月", "month", "名前", "name", "番目", "nd", "NLアウト", "nl-out", "ノンブロッキング", "non-blocking", "番目", "nth", "オフ", "off", "アウト", "out", "アウトバッファ", "out-buffer", "オーバーラップ", "overlap", "ページ", "p", "部分的", "partial", "パーツ", "parts", "ポート", "port", "位", "pos", "プライマリー", "primary", "第四次", "quaternary", "番目", "rd", "リアル", "real", "の交換", "replacement", "ルール", "rule", "同じケース", "samecase", "同一空間", "samespace", "スケジューラー", "scheduler", "秒", "second", "二次", "secondary", "秒", "seconds", "共有", "shared", "サイズ", "size", "スリップ", "slip", "スペック", "SPEC", "スカッシュ", "squash", "SS", "ss", "番地", "st", "ステータス", "status", "厳格", "strict", "下付き文字", "subscript", "上付き文字", "superscript", "三次", "tertiary", "テスト", "test", "番目", "th", "回", "times", "タイムゾーン", "timezone", "翻訳-nl", "translate-nl", "切り捨て", "truncate", "UID", "uid", "アップデート", "update", "値", "value", "ベントアット", "vent-at", "巻", "volume", "どこで", "where", "×", "x", "年", "year";
        %mapping{$key} // $key
    }
    method pragma2str (str $key) {
        my %mapping = "ダイナミックスコープ", "dynamic-scope", "死亡者", "fatal", "内部構造", "internals", "請求者", "invocant", "主義", "isms", "リブ", "lib", "モンキー", "MONKEY", "モンキーガッツ", "MONKEY-GUTS", "モンキー・シー・ノー・エヴァル", "MONKEY-SEE-NO-EVAL", "モンキータイピング", "MONKEY-TYPING", "プリコンパイル", "precompilation", "ソフト", "soft", "厳格", "strict", "トレース", "trace", "個の変数", "variables", "悩み", "worries";
        %mapping{$key} // $key
    }
    method system2str (str $key) {
        my %mapping = "件の承認", "ACCEPTS", "ビルド", "BUILD", "コールミー", "CALL-ME", "強制", "COERCE", "フォールバック", "FALLBACK", "メイン", "MAIN", "微調整", "TWEAK", "アップグレード-RAT", "UPGRADE-RAT";
        %mapping{$key} // $key
    }
}
